...
- No license is currently supplied with this `vnext` tree.
- Public release remains blocked until license status is explicitly resolved by the USER.
- A final v2 release/tag/license decision is a separate USER gate and is not performed by this README.
