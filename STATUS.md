...
| adr/0005 新增的多agent协作补丁（任务归属追踪表/协作协议/证据类型字段/框架自检等）尚未在多个真实项目中检验，目前只有下游 hermes-nas-experiment 一个真实使用场景 | 未补 |
...
（2026-08-01）下游真实使用项目 `hermes-nas-experiment` 在一次 AI 会话
